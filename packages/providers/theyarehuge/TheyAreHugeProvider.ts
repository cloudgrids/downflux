 ...
 * @description TheyAreHugeProvider is responsible for handling all interactions with the TheyAreHuge service.
 * @notes Available video qualities are `240p` and `480p`. The provider will attempt to fetch both, but availability may vary based on the video.
