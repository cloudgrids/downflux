import { HqPornExecArgs, HqPornOutput, IdentifierContext, PipelineExtractedItem, PipelineItem } from '@app/contracts';
import { MediaType } from '@app/shared';
import { DefaultPipeline } from './DefaultPipeline';

export class HqPornPipeline extends DefaultPipeline<HqPornExecArgs, HqPornOutput> {
