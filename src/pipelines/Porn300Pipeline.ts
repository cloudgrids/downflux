import { IdentifierContext, PipelineExtractedItem, PipelineItem, Porn300ExecArgs, Porn300Output } from '@app/contracts';
import { MediaType } from '@app/shared';
import { ImageExtension } from '@app/types';
import { DefaultPipeline } from './DefaultPipeline';

export class Porn300Pipeline extends DefaultPipeline<Porn300ExecArgs, Porn300Output> {
