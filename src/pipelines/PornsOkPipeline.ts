import { IdentifierContext, PipelineExtractedItem, PipelineItem, PornsOkExecArgs, PornsOkOutput } from '@app/contracts';
import { MediaType } from '@app/shared';
import { DefaultPipeline } from './DefaultPipeline';

export class PornsOkPipeline extends DefaultPipeline<PornsOkExecArgs, PornsOkOutput> {
