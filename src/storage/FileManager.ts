import { CreateSinkInput, CreateSinkOutput, ExecutionArgs, ExecutionResult, ResolvedFile, TranscodeOptions } from '@app/contracts';
import { InvalidDestinationException } from '@app/exceptions';
