import { HqPornProvider, OkPornProvider, PornsOkProvider, XHamsterProvider, XnXXProvider } from '../src/providers';
...
async function main() {
	...
	try {
		await new HqPornProvider('https://hqporn.xxx/beautiful-teen-chick-desires-orgasm_20486401.html')
