...
function patchRegion(source: string, region: string, content: string): string {
	const start = `// <auto-generated:${region}>`;
	const end = `// </auto-generated:${region}>`;
	const regex = new RegExp(`${start}[\\s\\S]*?${end}`, 'g');
	return source.replace(regex, `${start}\n${content}\n\t${end}`);
}
