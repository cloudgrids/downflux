...
Defined in: [util/interfaces/common/ExecutionArgs.ts:12](https://github.com/forkts/downflux/blob/e6be934e249b80ac51d3bc8b2250e75bef4b2af2/src/util/interfaces/common/ExecutionArgs.ts#L12)
...
[`JobOptions`](JobOptions.md).[`headers`](JobOptions.md#headers)
...
[`JobOptions`](JobOptions.md).[`timeoutMs`](JobOptions.md#timeoutms)
...
[`JobOptions`](JobOptions.md).[`retries`](JobOptions.md#retries)
...
[`JobOptions`](JobOptions.md).[`referer`](JobOptions.md#referer)
